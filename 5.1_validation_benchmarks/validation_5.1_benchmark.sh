...
for problem_name, problem in PROBLEM_SPECS:
    ...
    if problem_name == "free_suspended_bridge_256x256_0.075":
        convergence_path = save_kan_convergence(problem_name, ds)

# This check is now safer since convergence_path might be None
if "free_suspended_bridge_256x256_0.075" in [p[0] for p in PROBLEM_SPECS] and convergence_path is None:
    print("Warning: KAN convergence plot for free_suspended_bridge_256x256_0.075 was not generated, 'KAN' model might have been skipped.")
